...
const RidingPopUp = ({ setRidePopUpPanel, setConfirmPanel }) => {
    return (
        <div>
            ...
            <button onClick={() => setRidePopUpPanel(false)} className='bg-gray-300 p-2 px-13 text-xl font-semibold  rounded-xl '>Ignore</button>
            <button onClick={() => { setRidePopUpPanel(false), setConfirmPanel(true) }} className='bg-green-700  p-2  px-13 text-xl font-semibold text-white rounded-xl'>Accept</button>
