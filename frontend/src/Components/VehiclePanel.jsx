...
const VehiclePanel = ({ setVehicleRidePanel, setVehiclepanel, fare, setvehicleType }) => {
    return (
        <div>
            {/* Car  */}
            <div onClick={() => {
                setVehicleRidePanel(true),
                setVehiclepanel(false),
                setvehicleType('car')
            }} className="bg-gray-200 p-2 rounded-lg border-1 border-black overflow-hidden flex items-center gap-1.5 mb-3">
            ...
            <div onClick={() => {
                ...
                <div>
                    <h1 className='text-xl font-bold flex items-center pr-2'><FaRupeeSign />{fare?.bike}</h1>
                </div>
            </div>
            ...
            <div onClick={() => {
                setVehicleRidePanel(true),
                    setVehiclepanel(false),
                    setvehicleType('auto')
            }} className="bg-gray-200 p-2 rounded-lg border-1 border-black overflow-hidden flex items-center gap-1.5">
                <div className='flex items-center justify-center'>
